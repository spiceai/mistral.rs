...
// Backwards-compatible Vision aliases
pub type VisionModelBuilder = MultimodalModelBuilder;
pub type UqffVisionModelBuilder = UqffMultimodalModelBuilder;
pub type VisionMessages = MultimodalMessages;
